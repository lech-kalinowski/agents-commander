...
Agents Commander 0.1.7 supports opt-in semantic capture and offline, reviewed
...
The 0.1.7 startup/template hotfix does not change capture consent, review rules,
