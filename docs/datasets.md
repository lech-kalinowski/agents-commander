...
Agents Commander 0.1.10 supports opt-in semantic capture and offline, reviewed
...
fixes, plus 0.1.10 redraw/sidebar routing fixes, do not change capture consent,
review rules, dataset schemas or the
