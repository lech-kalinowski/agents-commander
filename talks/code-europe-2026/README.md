...
[`main` branch](https://github.com/lech-kalinowski/agents-commander/tree/main),
...
Current [source on GitHub](https://github.com/lech-kalinowski/agents-commander)
is open source under the [MIT License](../../LICENSE), including commercial use.
Preserve the copyright and permission notice and applicable
[third-party notices](../../THIRD_PARTY_NOTICES.md). Earlier published packages
retain their bundled license; merging source does not publish a new npm release.
